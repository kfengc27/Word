...
if ( ! function_exists( 'embla_header_nav' ) ) {
	...
	?>
	<div class="menu-wrap">
		<nav id="site-navigation" role="navigation" aria-label="<?php esc_attr_e( 'Header menu', 'embla' ); ?>" class="main-navigation" itemscope="itemscope" itemtype="http://schema.org/SiteNavigationElement">
