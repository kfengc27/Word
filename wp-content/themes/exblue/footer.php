...
?>
	...
	<footer>
		...
		<div id="sub-footer" style="display: none;">

		<div id="sub-footer-core" style="display: none;">
 		
 			<div class="copyright" style="font-color: white;">
			<?php  
	printf( __( '@Emotions In Choice Social Interest SIG' ) ); 
		?>
		</div> 
