  ...
  <div class="operationsbar">
    ...
    <div class="nav">
      <ul>
        ...
        <li><input type="submit" name="delete" value="Delete" onclick="return pg_confirm('<?php _e('Are you sure you want to delete this user permanently? You cannot undo this action.','profile-magic');?>')" /></li>
