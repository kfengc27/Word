...
<div class="uimagic">
    <form name="pm_add_group" id="pm_add_field" method="post">
        ...
        <div class="content">
            ...
            <div class="uimrow">
                <div class="uimfield">
                    <?php _e('Field Name','profile-magic'); ?>
                    <sup>*</sup></div>
                ...
                <div class="uimnote"><?php _e('Label of the field as it appears on forms and profiles. This does not apply to fields without labels such as Heading, Paragraph, Divider, Spacing.','profile-magic'); ?></div>
            </div>
            <div class="uimrow">
                <div class="uimfield">
                    <?php _e('Field Description:','profile-magic'); ?>
                </div>
                <div class="uiminput">
...
<?php _e('Paragraph Text:','profile-magic'); ?>
                    ...
                    <div class="uimnote"><?php _e('The text you want to appear in this field. HTML is supported. Which means you can use HTML tags like <i>b,i, u, em, strong, h1, h2...</i> etc. to style your content.','profile-magic'); ?> </div>
                </div>
...
<?php _e('Define allowed file types (file extensions):','profile-magic'); ?>
                    ...
                    <div class="uimnote"><?php _e('Separate multiple values by â€œ|â€?. For example PDF|JPEG|XLS','profile-magic'); ?> </div>
                </div>
...
<?php _e('Price:','profile-magic'); ?>
            ...
            <div class="uimrow" id="field_icon_div">
                <div class="uimfield">
<?php _e('Field Icon','profile-magic'); ?>
                </div>
                ...
                <div class="uimnote"> <?php _e('Jazz up your forms with field icons &#128247;. Icons appear at the beginning of the label. For best results use a square image. For e.g. <i>16px x 16px, 256px x 256px, 512px x 512px</i>...','profile-magic'); ?></div>
            </div>
...
?>
            ...
            <div class="uimrow" id="show_signup">
                <div class="uimfield">
<?php _e('Show in Sign-Up form','profile-magic'); ?>
                </div>
                <div class="uiminput">
                ...
                <div class="uimnote"><?php _e('The field will appear in the registration form when members sign up for this group. Alternatively, you can hide from the form, and users can then fill it up when editing their profiles later on.','profile-magic'); ?></div>
            </div>
...
<?php _e('Required?','profile-magic'); ?>
                ...
                <?php /* ?><div class="uimrow">
                  <div class="uimfield">
                  <?php _e( 'Can it be edited later?','profile-magic' ); ?>
                  </div>
                  <div class="uiminput">
...
<?php _e('Display on Profile Page','profile-magic'); ?>
                ...
                <div class="uimnote"><?php _e('Show this field on profile page of the members. It is totally possible to show a field in group registration form but hide from the profile page.','profile-magic'); ?></div>
            </div>
            <div class="childfieldsrow" id="displayprofilehtml" style=" <?php
                ...
                <div class="uimrow" id="field_visibility_option">
                    <div class="uimfield">
                                <?php _e('Visible for:','profile-magic'); ?>
                    </div>
...
<?php _e('Registered','profile-magic'); ?>
                    ...
                    <?php _e('Only Group Leader','profile-magic'); ?>
                            </li>

                        </ul>
                        <div class="errortext"></div>
                    </div>
                    <div class="uimnote"><?php _e('Set visibility of the profile field.','profile-magic'); ?></div>
                </div>
