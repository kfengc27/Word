    ...
    <div class="content">
      ...
      <div class="uimrow">
        ...
        <div class="uiminput">
          ...
          <div class="uimnote"><?php _e('When enabled, if user has not uploaded a profile image, ProfileGrid will fetch profile image associated with user email on <a href="https://gravatar.com" target="_blank">Gravatar</a>, a WordPress service for uploading and managing user avatars.','profile-magic');?></div>
      </div>
