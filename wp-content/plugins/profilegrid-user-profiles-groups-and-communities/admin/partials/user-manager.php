...
<div class="pmagic"> 
  ...
  <div class="operationsbar">
    ...
    <div class="nav">
      <ul>
        ...
        <li class="pm_action_button"><input type="submit" name="delete" value="<?php _e("Delete",'profile-magic');?>" onclick="return pg_confirm('<?php _e('You are going to delete selected users permanently. This action cannot be undone. Please confirm.','profile-magic');?>')" /></a></li>
        <li class="pm_action_button"><input type="button" name="move" value="<?php _e("Move",'profile-magic');?>" onclick="jQuery('.pm-popup').css('visibility', 'visible');" /></a></li>
  ...
  <div class="pm-popup pm-move-to-group pm-popup-height-auto" >
      ...
      <div class="pm-popup-field-name" style="padding:15px;" >
               ...
               <input type="submit" name="move" value="<?php _e("Move",'profile-magic');?>"style="padding-left:20px;"/>

               <p class="pm-warning"> <?php _e('You are changing the group of this user. All data associated with profile fields of old group will be hidden and the user will have to edit and fill profile fields associated with the new group.','profile-magic'); ?></p>
