...
if(filter_input(INPUT_POST,'submit_settings'))
{
	...
	if (!wp_verify_nonce($retrieved_nonce, 'save_upload_settings' ) ) die( 'Failed security check' );
  ...
  <form name="pm_upload_settings" id="pm_upload_settings" method="post">
    ...
    <div class="content">
      ...
      <div class="uimrow">
        ...
        <div class="uimnote"><?php _e('Set an upper limit to the size of profile images uploaded by users. Sizes are in Bytes. For example, for 2MB limit use 2097152. You can also use an <a href="http://whatsabyte.com/P1/byteconverter.htm" target="_blank">online convertor</a> for finding out exact values.','profile-magic');?></div>
      </div>
      ...
      <div class="uimrow">
        ...
        <div class="uimnote"><?php _e('Set an upper limit to the size of cover images uploaded by users. Sizes are in Bytes. For example, for 2MB limit use 2097152. You can also use an <a href="http://whatsabyte.com/P1/byteconverter.htm" target="_blank">online convertor</a> for finding out exact values.','profile-magic');?></div>
      </div>
