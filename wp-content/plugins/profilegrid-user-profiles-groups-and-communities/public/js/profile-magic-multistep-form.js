...
(function( $ ) {
	...
	$.fn.multipage = function(options) { 
		...
		settings = $.extend({stayLinkable:false,submitLabel:'Submit',hideLegend:false,hideSubmit:true,generateNavigation:true,activeDot:'&nbsp;&#x25CF;',inactiveDot:'&nbsp;&middot;'},options);
		id = '#' + $(this).attr('id');
		var form = $(this);			
			...
			if (settings.generateNavigation) { 
				if (settings.navigationFunction) { 
					...
					// insert navigation
                                        ...
                                        $('<div class="multipage_nav" id="'+id_name+'_nav"><a href="#" class="multipage_back" onclick="return  jQuery(\''+id+'\').prevpage();">Back</a><a href="#"  class="multipage_next" onclick="return jQuery(\''+id+'\').nextpage();">Next</a><span class="multipage_state"></span><div class="clearer"></div></div>').insertAfter(this);
				}
			}				
