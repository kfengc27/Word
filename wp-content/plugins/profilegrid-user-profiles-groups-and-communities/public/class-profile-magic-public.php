...
class Profile_Magic_Public {
   ...
   {  
            ...
            $users =  $dbhandler->pm_get_all_users($search,$meta_query_array,'',$offset,$limit,'ASC','ID',$exclude,$date_query);
            $total_users = count($dbhandler->pm_get_all_users($search,$meta_query_array,'','','','ASC','ID',$exclude,$date_query));
            ...
            $user_info =array();
               ...
               if(isset($total_users)){
                $return .="<div  class=\"pm-all-members pm-dbfl pm-pad10\">"
                       . translate('Total ','profile-magic')."<b>".$total_users
                       ."</b>". translate(' members','profile-magic')."</div>";
               }
            ...
            foreach($users as $user)
                {       
                    ...
                    $return ="<div class=\"pm-message pm-dbfl pm-pad10\">"
                            . translate("Sorry, your search returned no results." ,'profile-magic')
                            ."</div>";
                }
...
//                  'menu_icon' =>'dashicons-testimonial'
        ...
        public function pm_reject_friend_request()
	{
		...
		$dbhandler->update_row($identifier,'id',$requests->id,$data,array('%s','%d'),'%d');
                ...
                echo '<b>'.__('Request Rejected!',$this->profile_magic).'</b><br />'. sprintf(__("You cancelled friend request from %s.","profile-magic"),$username2);
		die;
	}
        ...
        public function pm_unfriend_friend()
	{
		...
		if($cancel_request==1):
                ...
                echo '<b>'.__('Request Removed!','profile-magic').'</b>';
                         ...
                         $username2 = $pmrequests->pm_get_display_name($u2);
                    echo '<b>'.__('Friend Removed!',$this->profile_magic).'</b><br />'.sprintf(__("You have removed %s from your friend list.","profile-magic"),$username2);
                endif;
        ...
        public function pm_show_settings_content($uid,$gid)
	{
            ...
            if($current_user->ID ==$uid)
            {
                    echo '<div id="pg-settings" class="pm-dbfl">';
        ...
        public function pg_post_published_notification($ID, $post)
        {
            ...
            $gid = $pmrequests->profile_magic_get_user_field_value($userid,'pm_group');            
            if(isset($gid) && $pm_blog_notification_user=="1")
            {
                $pmemail->pm_send_group_based_notification($gid,$userid,'on_published_new_post',$ID);
            }
        }
