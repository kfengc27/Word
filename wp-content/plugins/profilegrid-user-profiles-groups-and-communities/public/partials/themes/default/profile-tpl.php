...
$group_page_link = add_query_arg( 'gid',$gid,$group_page_link );
?>
<div class="pmagic"> 
  ...
  <div class="pm-group-view pm-dbfl">
    ...
    <div class="pm-profile-tabs pm-dbfl" id="pg-profile-tabs">
     <div class="pm-section-nav-horizental pm-dbfl">
            ...
            <div id="pg-profile-menuToggle">
                <input type="checkbox" id="pg-toggle-menu-close" />
                <span class="pg-toggle-menu-icon"></span> <span class="pg-toggle-menu-icon"></span><span class="pg-toggle-menu-icon"></span>
        <ul class="pm-difl pm-profile-tab-wrap pm-border-bt" id="pg-mobile-menu">	
