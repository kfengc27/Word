...
if(isset($uid))
{
	...
	if(isset($gid) && $gid!='') $groupinfo = $dbhandler->get_row('GROUPS',$gid);
        ...
        {
            echo '<div class="pm_message">'.__('Your profile is not yet associated with any parent profile group. To make it visible please associate it with a group first.','profile-magic').'</div>';
        }
    else:
