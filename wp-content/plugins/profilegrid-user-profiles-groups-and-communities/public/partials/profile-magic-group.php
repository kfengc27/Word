...
if(!empty($row))
{
	...
	$users =  $dbhandler->pm_get_all_users('',$meta_query,'',$offset,$limit,'ASC','ID',$hide_users);
...
{
	_e( 'Sorry, this group is currently not accessible. Either it was deleted or its ID does not matches.','profile-magic' ); 
}
?>