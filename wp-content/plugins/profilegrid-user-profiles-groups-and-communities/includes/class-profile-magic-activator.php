...
class Profile_Magic_Activator {
	...
	public function create_pages() {
		...
		$pages['PM_Group'] = array('post_type' => 'page','post_title' => 'Default User Group','post_status' => 'publish','post_name' => 'pm_group','post_content' => '[PM_Group id="1"]');
		...
		$pages['PM_Add_Blog'] = array('post_type' => 'page','post_title' => 'Submit New Blog Post','post_status' => 'publish','post_name' => 'pm_submit_blog','post_content' => '[PM_Add_Blog]');
		// The Query
		...
		if($dbhandler->pm_count('GROUPS')==0) {
			$data = array(
                            ...
                            'group_desc'=>'This the default user group. All existing registered users are automatically assigned this group. Groups can be modified or deleted by the admin.',
