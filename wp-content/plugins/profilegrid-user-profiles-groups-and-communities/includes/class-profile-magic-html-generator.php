...
class PM_HTML_Creator
{
		...
		$j=1;
                foreach($sections as $section)
                {
                        ...
                        if(isset($fields) && !empty($fields))
                        {
                                ...
                                foreach($fields as $field)
                                {
                                    if($value!='' && isset($value[$field->field_key])){$field_value = $value[$field->field_key]; }else{ $field_value='';}
                                       echo '<div class="pmrow">';
       ...
       public function pm_get_user_blog_posts($uid,$pagenum=1,$limit=10)
        {
          ...
          // echo count($posts_array);
            ...
            else
            {
                ...
                {
                    echo "<div class='pg-alert-warning pg-alert-info'>";
                     _e("Sorry, $displayname has not made any blog posts yet.",'profile-magic');
                    echo "</div>";
                }
    ...
    <path d="M0-.5h24v24H0z" fill="none"/>
            ...
            <div class="pm-section-left-panel pm-section-nav-vertical pm-difl " id="thread_pane">
                ...
                <div class="dbfl pm-new-message-area"><a title="Click here to compose the message" id="new_message_btn" onclick="create_new_message()"><i class="fa fa-plus" aria-hidden="true"></i> New Message</a></div>
